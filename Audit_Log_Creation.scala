...
// MAGIC 
// MAGIC //Example value: MY_Inital_LA
...
// MAGIC %scala
// MAGIC var Load_Data_Query = "exec adf.uspPipeAudit '" + Batch_ID + "','" + Pipeline_Name + "','" + Pipeline_Trigger_ID + "','" + Pipeline_Trigger_Name + "','" + Pipeline_Trigger_Type + "','" + Error_Message + "','NA','" + Data_Source + "','" + Current_DateTime + "'"
